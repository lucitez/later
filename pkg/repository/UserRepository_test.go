...
var user, err = entity.NewUserFromSignUp(
...
func TestByIDs(t *testing.T) {
	...
	user2, _ := entity.NewUserFromSignUp(
	...
	util.AssertEquals(t, actual, []entity.User{*user, *user2})
}
...
func TestAll(t *testing.T) {
	...
	util.AssertEquals(t, actual, []entity.User{*user2})
}
